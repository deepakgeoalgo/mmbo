        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body pt-0">
                            ...
                            <div class="chart-info d-flex justify-content-between mb-1 mt-4">
                                <div class="series-info d-flex align-items-center mt-5">
                                    <i class="feather icon-monitor font-medium-2 text-primary"></i>
                                    <span class="text-bold-600 mx-50">Desktop</span>
                                    <span> - 58.6%</span>
                                </div>
                                <div class="series-result mt-4">
                                    <span>2%</span>
            ...
            <div class="col-lg-4 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div id="product-order-chart" class="mb-0"></div>
                            <div class="chart-info d-flex justify-content-between mb-1">
                                <div class="series-info d-flex align-items-center">
            ...
            <div class="col-lg-4 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <ul class="list-group list-group-flush customer-info mt-4">
